...
var ReactSelectMe = function (_PureComponent) {
  ...
  function ReactSelectMe(props) {
    ...
    _this.patchSelectedOption = function (selectedOption, options) {
      ...
      return _this.validateDataStructure((_this$validateDataStr = {}, _defineProperty(_this$validateDataStr, valueKey, selectedOption), _defineProperty(_this$validateDataStr, labelKey, selectedOption), _this$validateDataStr));
    };
    ...
    _this.getSelectedOptions = function () {
      ...
      }) : _this.validateDataStructure([_this.patchSelectedOption(value, options)]);
    };
