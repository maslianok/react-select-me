...
var ReactSelectMe = function (_PureComponent) {
  ...
  function ReactSelectMe(props) {
    ...
    _this.toImmutable = function (data) {
    ...
    _this.patchSelectedOption = function (selectedOption, options) {
      ...
      var option = options.find(function (o) {
        return _this.getProp(o, valueKey) === selectedOption;
      });
      if (option) {
        return option;
      }
      ...
      return _this.toImmutable((_this$toImmutable = {}, _defineProperty(_this$toImmutable, valueKey, selectedOption), _defineProperty(_this$toImmutable, labelKey, selectedOption), _this$toImmutable));
    };
    ...
    _this.renderList = function () {
      ...
      var listClasses = cs('dd__list', s.dd__list, 'dd__openTo' + direction, s['dd__openTo' + direction], (_cs = {}, _defineProperty(_cs, s.dd__listVirtualized, virtualized), _defineProperty(_cs, 'dd__listVirtualized', virtualized), _cs));

      var rowCount = _this.getCount(options);
      if (rowCount && virtualized) {
        var rowClassName = cs('dd__optionVirtualized', s.dd__optionVirtualized);
        return React.createElement(
          ...
          function (_ref) {
            ...
            return React.createElement(List, {
              ...
              rowHeight: _this.getOptionHeight,
              rowCount: rowCount,
    ...
    _this.renderOption = function (option, selectedOptions, style) {
      ...
      var className = cs('dd__option', s.dd__option, _defineProperty({
        dd__selectedOption: isSelected
      }, s.dd__selectedOption, isSelected));

      var label = typeof optionRenderer === 'function' ? optionRenderer(option, selectedOptions) : React.createElement(
        'div',
        { className: className },
    ...
    _this.renderSelectedBlock = function () {
      ...
      var selectedBlockClasses = cs('dd__selected', s.dd__selected);
      var placeholderClasses = cs('dd__placeholder', s.dd__placeholder);
      ...
      return React.createElement(
        ...
        selectedElements,
        noOptionsSelected && (!searchable || !opened) && React.createElement(
          'div',
    ...
    _this.renderSearchInput = function () {
      ...
      var selectedOptions = _this.getSelectedOptions();
      var className = cs('dd__search', s.dd__search);
    ...
    _this.renderSelectedItem = function (option) {
      ...
      var selectedOptionClasses = cs('dd__selectedItem', s.dd__selectedItem);
      var crossIconClasses = cs('dd__crossIcon', s.dd__crossIcon);
    ...
    _this.renderIcon = function () {
      ...
      var className = cs('dd__expandIcon', s.dd__expandIcon);
      ...
      return React.createElement(
        ...
        React.createElement('path', { d: path, transform: 'translate(-306 -1308)' })
      );
    };
    ...
    _this.renderAddNewItem = function () {
      ...
      var classNames = cs('dd__option', s.dd__option);
    ...
    _this.renderNoItemsFound = function () {
      ...
      var classNames = cs('dd__option', 'dd__optionDisabled', s.dd__option, s.dd__optionDisabled);
    ...
    _this.getOptions = function () {
      ...
      if (_this.getCount(options)) {
        ...
        return options.map(function (option) {
          var _this$toImmutable2;

          return _this.toImmutable((_this$toImmutable2 = {}, _defineProperty(_this$toImmutable2, labelKey, option), _defineProperty(_this$toImmutable2, valueKey, option), _this$toImmutable2));
        });
      }
    ...
    _this.getSelectedOptions = function () {
      ...
      if (!value || multiple && !_this.getCount(value)) {
        return _this.toImmutable([]);
      }

      return multiple ? value.map(function (v) {
        return _this.patchSelectedOption(v, options);
      }) : _this.toImmutable([_this.patchSelectedOption(value, options)]);
    };
    ...
    _this.getOptionHeight = function (_ref3) {
    ...
    _this.onAddNewItem = function () {
      ...
      if (typeof onAddNewItem === 'function') {
        onAddNewItem(_this.getSearchString(), _this.getSelectedOptions());
      }
    };
  ...
  _createClass(ReactSelectMe, [{
    ...
    *****************************************/
    value: function render() {
      ...
      var wrapperClassnames = cs('dd__wrapper', s.dd__wrapper, (_cs3 = {
        dd__opened: opened,
        dd__error: error,
        dd__multi: multiple,
      ...
      var selectControlClasses = cs('dd__selectControl', s.dd__selectControl);
